...
class SCR_CTI_DefensesUS
{
	...
	private void fillUp()
	{
		...
		resname.Insert("{2A24B40D6887140B}Prefabs/Compositions/Misc/SubCompositions/Utility/Helipad_Lights_US_01.et");
		name.Insert("HeliPad");
		price.Insert(500);
		category.Insert("");
		distance.Insert(12);
	...
	void ~SCR_CTI_DefensesUS()
	{
		if (g_US_Defenses) g_US_Defenses.Clear();
		g_US_Defenses = null;
