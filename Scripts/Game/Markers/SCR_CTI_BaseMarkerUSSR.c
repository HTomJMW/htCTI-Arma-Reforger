[EntityEditorProps(category: "GameScripted/CTI", description: "CTI Base Marker USSR")]
class SCR_CTI_BaseMarkerUSSRClass : BaseGameEntityClass
{
};

class SCR_CTI_BaseMarkerUSSR : BaseGameEntity
{
