...
class SCR_CTI_PurchaseVehicleAction : ScriptedUserAction
{
	...
	{	
		...
		{
			resource = Resource.Load("{259EE7B78C51B624}Prefabs/Vehicles/Wheeled/UAZ469/UAZ469.et");
			int unitIndex = m_gameMode.UnitsUSSR.findIndexFromResourcename("{259EE7B78C51B624}Prefabs/Vehicles/Wheeled/UAZ469/UAZ469.et");
			SCR_CTI_UnitData unitData = m_gameMode.UnitsUSSR.g_USSR_Units[unitIndex];
			price = unitData.getPri();
		} else {
			resource = Resource.Load("{F649585ABB3706C4}Prefabs/Vehicles/Wheeled/M151A2/M151A2.et");
			int unitIndex = m_gameMode.UnitsUS.findIndexFromResourcename("{F649585ABB3706C4}Prefabs/Vehicles/Wheeled/M151A2/M151A2.et");
